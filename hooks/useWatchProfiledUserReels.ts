...
import { fetchGraphQl, ReelsManagerListenerEvents, ReelsMangerListener, GetProfiledUserProfileDetails, GraphqlError, socket, WatchLifterProfileReelsComments, WatchLifterProfileReelsCommentsChildren } from "../utils";

import { getProfiledUserProfileDetails } from "../graphQlQuieries";
...
export const useWatchProfiledUserReels = (token: string, profiledUserId: string, refreshing: boolean ) => {
    ...
    const [data, setData] = useState<GetProfiledUserProfileDetails | undefined>();
        ...
        fetchGraphQl(getProfiledUserProfileDetails, { token, profiledUserId })
            .then(res => {
                ...
                if (res.errors) {
                    ...
                    setData(prev => ({
                        ...prev,
                        ...res.data.getProfiledUserProfileDetails,
                    }));
